...
public class MapComponent extends JComponent
{
	...
	private static Map<EdgeDirection, List<Point2D>> ROADS;//Clear
	private static List<Point2D> SETTLEMENT;//Clear
	private static List<Point2D> CITY;//Clear
	private static Map<VertexDirection, Point2D> VERTEX_POINTS;//Clear
	private static Map<EdgeDirection, Point2D> EDGE_POINTS;//Clear
	...
	private Map<HexLocation, HexType> hexes;//clear
	private Map<EdgeLocation, CatanColor> roads;//clear
	private Map<VertexLocation, CatanColor> settlements;//clear
	private Map<VertexLocation, CatanColor> cities;//clear
	private Map<EdgeLocation, PortType> ports;//clear
	private Map<HexLocation, Integer> numbers;//clear
	private HexLocation robber;//clear
	private Map<HexLocation, Point2D> allHexPoints;//clear
	private Map<VertexLocation, Point2D> allVertexPoints;//clear
	private Map<EdgeLocation, Point2D> allEdgePoints;//clear
	...
	public void removeRoad(EdgeLocation edgeLocation){
		if(roads.containsKey(edgeLocation.getNormalizedLocation())){
			roads.remove(edgeLocation);
			this.repaint();
		}
	}
