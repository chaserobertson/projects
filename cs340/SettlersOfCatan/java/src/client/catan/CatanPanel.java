...
public class CatanPanel extends JPanel
{
	...
	public CatanPanel()
	{
		...
		discardController = new DiscardController(discardView, discardWaitView, ModelReferenceFacade.getInstance());
		...
		rollController = new RollController(rollView, rollResultView, ModelReferenceFacade.getInstance());
