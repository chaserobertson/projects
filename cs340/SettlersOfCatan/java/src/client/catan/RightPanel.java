...
public class RightPanel extends JPanel
{
	...
	public RightPanel(final IMapController mapController)
	{
		...
		devCardController = new DevCardController(playCardView, buyCardView, soldierAction,
													roadAction, ModelReferenceFacade.getInstance());
		...
		pointsController = new PointsController(pointsView, finishedView, ModelReferenceFacade.getInstance());
		pointsView.setController(pointsController);
		
		// Initialize resource bar view and controller
		//
		resourceView = new ResourceBarView();
		resourceController = new ResourceBarController(resourceView, ModelReferenceFacade.getInstance());
