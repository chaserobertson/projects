...
public class MainActivity extends ActionBarActivityView implements IMainMenuView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO: DONE Set this activity's controller to an instance of your MainMenuController
        //TODO: DONE Pass the MainMenuController's constructor a reference to its IMainMenuView (this)
        IMainMenuController controller = new MainMenuController(this);
        setController(controller);


        //TODO: DONE Initialize your database
        /**
         ...
         * db.close();
         */
        Database.SINGLETON.setContext(getBaseContext());
        //db.initialize();
        //GameDataImporter gameDataImporter = new GameDataImporter(());
