...
class Matrix:
    ...
    def init_from(self, matrix, row_start, col_start, row_count, col_count):
        ...
        self.attr_def = matrix.attr_def[col_start:col_start+col_count]
                    ...
                    if line.lower().startswith("@relation"):
                        ...
                        if attr_def.lower() not in ("real", "continuous", "integer"):
                            ...
                            for val in attr_vals:
                                ...
                                val_idx += 1
                            self.attr_def += ['nominal']
                        else:
                            self.attr_def += [attr_def.lower()]
    ...
    def attr_type(self, col):
        """Get the type of the specified attribute"""
        return self.attr_def[col]
    ...
    def value_count(self, col):
        """
        Get the number of values associated with the specified attribute (or column)
